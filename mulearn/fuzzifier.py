...
class CrispFuzzifier(Fuzzifier):
    ...
    def __init__(self):
        ...
        :param threshold: threshold used to output the fuzzifier value.
        :type profile: float
        """
        super().__init__()

    default_profile = "fixed"
    def fit(self, squared_R, mu, squared_radius, profile=default_profile):
        ...
        :raises: ValueError if profile is not set either to `'fixed'` or
          to `'infer'`.
...
class OldCrispFuzzifier(Fuzzifier):
    """Crisp fuzzifier.
...
class OldLinearFuzzifier(Fuzzifier):
    """Linear fuzzifier.
...
class LinearFuzzifier(Fuzzifier):
    ...
    def fit(self, squared_R, mu, squared_radius, profile=default_profile):
        ...
        :raises: ValueError if profile is not set to `'fixed'`, `'triangular`'
          or `'infer'`.
...
class ExponentialFuzzifier(Fuzzifier):
    ...
    def fit(self, squared_R, mu, squared_radius, profile=default_profile):
        ...
        :raises: ValueError if profile is not set either to `'fixed'`,
...
class OldExponentialFuzzifier(Fuzzifier):
    """Exponential fuzzifier.
...
class OldQuantileConstantPiecewiseFuzzifier(Fuzzifier):
    """Quantile-based constant piecewise fuzzifier.
...
class OldQuantileLinearPiecewiseFuzzifier(Fuzzifier):
    """Quantile-based linear piecewise fuzzifier.
